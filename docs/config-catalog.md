...
Source: [`packages/fs/fs-observation-policy/src/index.ts:21`](../packages/fs/fs-observation-policy/src/index.ts)
...
Source: [`packages/host/kimi-quota/src/index.ts:25`](../packages/host/kimi-quota/src/index.ts)
...
Source: [`packages/llm/llm-pi-ai/src/config.ts:178`](../packages/llm/llm-pi-ai/src/config.ts)
...
Source: [`packages/memory/memory-log/src/index.ts:43`](../packages/memory/memory-log/src/index.ts)
...
- `@deepseek-ai/dsh-tool-memory` — requires `tools` · `memory` · `systemPrompt` ([`packages/memory/tool-memory/src/index.ts`](../packages/memory/tool-memory/src/index.ts))
