...
| [memory.md](memory.md) | the permanent-memory seam: the `MemoryService` six-operation contract, `MemoryError`, the log/tree store layout, and the agent-in-the-loop compression lifecycle |
