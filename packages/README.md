...
| [`coding/`](coding/README.md) | Cross-device coding-activity log behind the web coding-time tracker | Product — stable API |
...
| [`memory/`](memory/README.md) | Memory capability family: permanent agent-curated memory seam, append-only log provider, and the model-facing memory tool | Product — stable API |
