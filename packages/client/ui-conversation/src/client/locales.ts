...
export const zh = {
  ...
  'message.autobio.memory': '记忆形成',
  'message.autobio.memory.forming': '正在形成记忆…',
  'message.autobio.memory.stats': '{chunks} 个区块 · {summaries} 条回忆（L1 {l1} · L2 {l2} · L3 {l3}）',
  'message.autobio.memory.entry': '新增 {id} · 约 {tokens} tokens',
...
export const en = {
  ...
  'message.autobio.memory': 'Memory formation',
  'message.autobio.memory.forming': 'Forming memory…',
  'message.autobio.memory.stats': '{chunks} chunks · {summaries} recollections (L1 {l1} · L2 {l2} · L3 {l3})',
  'message.autobio.memory.entry': 'new {id} · ~{tokens} tokens',
