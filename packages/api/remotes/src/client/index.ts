...
import kimiQuotaRemote from '@deepseek-ai/dsh-host-kimi-quota/remote'
...
export type { KimiQuotaSnapshot, KimiQuotaUsageRow, KimiQuotaWindowRow } from '@deepseek-ai/dsh-host-kimi-quota/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-kimi-quota/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, kimiQuotaRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
