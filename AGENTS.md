...
packages/    @deepseek-ai/dsh-<pkg> workspaces at packages/<group>/<pkg>/
  ...
  coding/      cross-device coding-activity log (bridged interaction spans)
...
mobile/      Self-contained Android app (Capacitor shell + on-device Termux Node); outside the pnpm workspace (see mobile/README.md)
